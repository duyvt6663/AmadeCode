...
import { Logout } from '@/app/components/workspace/top/logout'
import { useSetRecoilState } from 'recoil'
import { auth_modal_state } from '@/app/atoms/auth_atom'
import Image from 'next/image'
import { FaChevronLeft, FaChevronRight } from 'react-icons/fa'
import { BsList } from 'react-icons/bs'
import { Timer } from '@/app/components/workspace/top/timer'
...
export function Topbar({ problemPage }: { problemPage: boolean }) {
  ...
  const handleProblemChange = (isForward: boolean) => {
    const { order } = problems[params.slug as string] as Problem
